...
public class EstatesAssemblerTest {
    ...
    public void createDtoWithInvalidAddressShouldThrowException() throws InvalidEstateException{
        //Given
        doThrow(new InvalidEstateException()).when(estateValidator).validate(VALID_TYPE_ESTATE, INVALID_ADDRESS, VALID_PRICE);
        //When
    ...
    public void createDtoWithInvalidPriceShouldThrowException() throws InvalidEstateException{
        //Given
        doThrow(new InvalidEstateException()).when(estateValidator).validate(VALID_TYPE_ESTATE, VALID_ADDRESS, INVALID_PRICE);
        //When
