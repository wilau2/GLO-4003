package ca.ulaval.glo4003.b6.housematch.domain.estate.builder;
...
public class DescriptionBuilder {
   ...
   public Description buildDescription() {
      return new Description(newNumberOfBedRooms, newNumberOfBathrooms, newNumberOfRooms, newNumberOfLevel,
            newYearsOfConstruction, newBuildingDimensions, newLivingSpaceAreaSquareMeter, newMunicipalValuation,
            newBackyardOrientation);
   }
